...
export async function registerWebAppAuth(app) {
    app.post('/webapp', async (request, reply) => {
        ...
        const payload = {
            ...
            role: env.TELEGRAM_ADMIN_USERNAMES.includes(user.username || '') ? 'admin' : 'user',
        };
