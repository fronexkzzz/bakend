...
export async function mtSendCodeUnauth(phone) {
    ensureCreds();
    ...
    // @ts-ignore
    return { phoneCodeHash: res.phoneCodeHash, timeout: res.timeout || 300, session };
}
export async function mtSignInOrUp(phone, code, phoneCodeHash, session) {
    ensureCreds();
